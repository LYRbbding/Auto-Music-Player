...
#define SSID        "vivo Z5x" //热点名称
#define PASSWORD    "1234567890"//Wi-Fi密码
#define DEVICEID    "562324123" //OneNet上的设备ID
String apiKey = "LgaoqvCcR2SlZl861B1AVpZH9DE=";//APIKey
...
{   
  ...
  Serial.print("环境音量："); 
    Serial.println(analogRead(mic_pin)); //串口打印MIC读数
    delay(500); 
...
jsonToSend="{\"Temperature\":";
    ...
    //新增
    jsonToSend+=",\"button\":";
    dtostrf(buttonState,1,2,buf);
    jsonToSend+="\""+String(buf)+"\"";
    jsonToSend+=",\"volume\":";
    dtostrf(analogRead(mic_pin),1,2,buf);
    jsonToSend+="\""+String(buf)+"\"";
    jsonToSend+="}";
